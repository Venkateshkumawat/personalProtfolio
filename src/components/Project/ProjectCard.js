    ...
    return (
        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-lg dark:bg-secondary dark:border-gray-700 relative overflow-hidden">
            ...
            <div className="relative p-5">
                ...
                <a href={project.link} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-accent rounded-lg hover:bg-secondary-90 focus:ring-4 focus:outline-none focus:ring-secondary-300 dark:bg-accent-600 dark:hover:bg-secondary-90 dark:focus:ring-primary-800">
                    Read more
